...
return ( 
    ...
    <div>
        <h1 className="font-medium leading-tight text-5xl mt-0 mb-2 text-center text-black-600">Add Notes</h1>
            ...
            <form>
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 light:bg-gray-700 light:border-gray-600">
                    ...
                    <div className="mb-4">
                        ...
                        <input  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="title"  name="title" placeholder="title" onClick={onChange}   required />
                    </div>
                    <div className="px-4 py-2 bg-white rounded-b-lg light:bg-gray-800">
                    <div className="mb-4">
                        ...
                        <input  onClick={onChange} id="tag"   name="tag" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" placeholder="Add tag here.."  required  />
                    </div>
                    </div>
                    ...
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor='description'>
                        ...
                        <textarea  onChange={onChange} id="description"  name="description" rows="8" className="block w-full px-0 text-sm text-gray-800 bg-white border-0 light:bg-gray-800 focus:ring-0 light:text-white light:placeholder-gray-400" placeholder="Write an article..."  required  ></textarea>
                ...
                <button  type="button" onClick={handleClick} className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 light:focus:ring-blue-900 hover:bg-blue-800">
                    add note
                </button>
            </form>
